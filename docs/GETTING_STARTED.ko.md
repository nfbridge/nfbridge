...
2. 앱 ZIP을 풀고 `Neo Film Bridge.app`을 엽니다. Apple Silicon용 빌드이며 macOS 14.0 이상을 요구합니다. 실제 시험은 macOS 26.6.2에서 했습니다. Apple 공증을 받지 않아 차단되면, 신뢰하는 파일인지 확인한 뒤 **시스템 설정 → 개인정보 보호 및 보안 → 그래도 열기**를 사용하세요. [Apple 안내](https://support.apple.com/en-us/102445)
