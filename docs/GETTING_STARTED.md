...
2. Unzip the app package and open `Neo Film Bridge.app`. This Apple Silicon build requires macOS 14.0 or later; it has only been tested on macOS 26.6.2. The app is not Apple-notarized. If a Mac blocks a copy you trust, use **System Settings → Privacy & Security → Open Anyway**. [Apple's instructions](https://support.apple.com/en-us/102445)
...
GUI import, recording changes and erasure were physically exercised on the developer-owned Mac/F100 setup. Other cables, Macs and a fresh account's first launch remain untested. [Validation scope](VALIDATION.md)
