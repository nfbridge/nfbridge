...
GUI import, recording changes and erasure were physically exercised on the project Mac/F100 setup. Other cables, Macs and a fresh account's first launch remain untested. [Validation scope](VALIDATION.md)
