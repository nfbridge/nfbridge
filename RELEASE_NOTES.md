...
개발자가 소유한 Mac·F100과 Prolific 케이블 구성에서 GUI 가져오기, 기록 설정 변경, 삭제를 실물로 시험했습니다. 다른 카메라나 케이블에서도 된다는 뜻은 아닙니다. 실행 파일은 Apple Silicon 및 macOS 14.0 이상을 대상으로 하지만 실제 시험은 macOS 26.6.2 한 환경에서 했습니다. 새 사용자 계정에서 내려받아 처음 여는 전 과정은 아직 검증하지 않았습니다. 앱은 ad-hoc 서명됐으며 Apple 공증은 받지 않았습니다.
